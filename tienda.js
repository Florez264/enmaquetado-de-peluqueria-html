...
function addToCartClicked(event){
    ...
    const itemImage = card.querySelector('.imag').src;
...
<div class="row shoppingCartItem">
      <div class="col-6">
          <div class="shopping-cart-item d-flex align-items-center h-100 border-bottom pb-2 pt-3">
              <img src=${itemImage} class="shopping-cart-imag">
  ...
  shoppingCartRow.querySelector('.buttonDelete').addEventListener('click',removerShoppingCartItem);
...
function upadateShoppingCartTotal(){
    let Total = 0;
...
function removerShoppingCartItem(event){
